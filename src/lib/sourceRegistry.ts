...
export const SOURCE_REGISTRY: SourceLicenseInfo[] = [
  ...
  {
    id: "firms",
    provider: "NASA FIRMS (VIIRS satellite thermal-anomaly detection)",
    url: "https://firms.modaps.eosdis.nasa.gov/api/area/",
    license: "US government work — public domain (general NASA open-data policy; no FIRMS-specific terms page found confirming this in so many words)",
    commercialUse: "unclear",
    redistributionAllowed: "unclear",
    attributionRequired: true,
    cachingAllowed: true,
    maxCacheAgeNotes: "NRT data updates continuously (~3h satellite-to-API latency); this app re-fetches every ingest cycle.",
    rateLimit: "5,000 transactions per 10-minute window per MAP_KEY.",
    apiKeyRequired: true,
    termsLastChecked: "2026-09-03",
  },
  {
