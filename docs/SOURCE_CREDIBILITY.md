...
| Times of Israel | Independent (chairman Seth Klarman, US-based Baupost Group founder), ad/subscription/donation funded | Left-Center | High | **Removed 2026-09-11** — not a credibility reassessment, its feed had been returning a hard 403 (WAF/bot-block) on every ingest cycle for the whole session, never once successfully fetched. |
...
| Haaretz | Schocken family (75%), Leonid Nevzlin (25%, Russian-Israeli businessman) | Left | High | Israeli-domestic-critical counterweight to Times of Israel (removed, see above) — same disclosed-lean logic as Meduza/Moscow Times. Gives the Israeli vantage point on its own now. |
